    ...
    public class Unpacker
    {
        ...
        static bool ExcludeDummy(byte[] pRcvData)
        {
            ...
            if ((Packing & 8) > 0)
            {
                ...
                ushort v2 = (ushort)(pRcvData[0] - (p6 % 13)); // _mUse? no idea wtf this is
        ...
        static bool UnpackData(SessionInfo sessionInfo, byte[] pRcvData)
        {
            ...
            //Console.WriteLine("Tail value (checksum): {0}", Util.ByteToHex(calcTailValue));
        ...
        public static ushort Unpack(SessionInfo sessionInfo, byte[] pRcvData)
        {
            ...
            //Console.WriteLine("ExcludeDummy returned {0}", excludeDummy);
            if (!excludeDummy)
            ...
            try
            {
                ...
                //Console.WriteLine("UnpackData returned {0}", unpackData);
                if (!unpackData)
